...
Call the module in your pipeline with:
...
** Theme of the 2023 nf-core hackathon: Testing
...
#+beamer: \pause
- _Oct 10th, 2022_ - Nicolas begins the modern era, submitted a PR for nf-test
...
** The problem with testing pipelines :ATTACH:
...
#+beamer: \pause
- Think +AWS+ GitHub actions batch
...
- nf-core/modules
- Testing at nf-core
- Conversion of testing to nf-test
